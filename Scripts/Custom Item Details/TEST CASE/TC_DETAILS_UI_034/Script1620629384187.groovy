...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Meter connectivity'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Meter connectivity'), 0)
