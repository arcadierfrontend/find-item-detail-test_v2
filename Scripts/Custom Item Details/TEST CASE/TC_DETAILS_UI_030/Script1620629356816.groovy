...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Intended use'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Intended use'), 0)
