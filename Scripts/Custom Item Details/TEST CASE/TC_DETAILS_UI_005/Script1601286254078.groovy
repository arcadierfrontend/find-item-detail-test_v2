...
WebUI.waitForElementVisible(findTestObject('Item Details Objects/Page_diagnostics/Merchant_name'), 0)

WebUI.verifyElementClickable(findTestObject('Item Details Objects/Page_diagnostics/Merchant_name'))
