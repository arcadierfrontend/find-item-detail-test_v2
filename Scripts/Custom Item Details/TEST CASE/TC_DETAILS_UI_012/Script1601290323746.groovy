...
WebUI.waitForElementVisible(findTestObject('Item Details Objects/Page_diagnostics/btn_Procure_from_other_Agencies'), 0)

WebUI.verifyElementClickable(findTestObject('Item Details Objects/Page_diagnostics/btn_Procure_from_other_Agencies'))
