...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Unit of measure'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Unit of measure'), 0)
