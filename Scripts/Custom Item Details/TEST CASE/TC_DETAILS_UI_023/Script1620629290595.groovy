...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Coding of the meter'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Coding of the meter'), 0)
