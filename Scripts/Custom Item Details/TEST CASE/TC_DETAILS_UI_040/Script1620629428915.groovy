...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Sample type'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Sample type'), 0)
