...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Country of manufacture'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Country of manufacture'), 0)
