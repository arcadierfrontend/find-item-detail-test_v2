...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Operating conditions'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Operating conditions'), 0)
