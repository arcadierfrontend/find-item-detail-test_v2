...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Compatible test strips'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Compatible test strips'), 0)
