...
WebUI.waitForElementVisible(findTestObject('Item Details Objects/Page_diagnostics/Page_diagnostics/span_Packaging_labeling'), 
    0)

WebUI.verifyElementPresent(findTestObject('Item Details Objects/Page_diagnostics/Page_diagnostics/span_Packaging_labeling'), 
    0)
