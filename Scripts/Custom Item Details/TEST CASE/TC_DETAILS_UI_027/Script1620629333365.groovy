...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Description'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Description'), 0)
