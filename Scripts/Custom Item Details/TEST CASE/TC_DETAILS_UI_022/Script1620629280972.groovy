...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Alerts'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Alerts'), 0)
