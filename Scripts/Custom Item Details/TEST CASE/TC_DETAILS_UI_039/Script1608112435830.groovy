...
WebUI.waitForElementVisible(findTestObject('Item Details Objects/Page_diagnostics/Page_diagnostics/span_Lead_Time_(days)'), 
    0)

WebUI.verifyElementPresent(findTestObject('Item Details Objects/Page_diagnostics/Page_diagnostics/span_Lead_Time_(days)'), 
    0)
