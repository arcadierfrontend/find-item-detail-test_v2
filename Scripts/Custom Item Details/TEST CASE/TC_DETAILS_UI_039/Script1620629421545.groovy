...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Regulatory approval'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Regulatory approval'), 0)
