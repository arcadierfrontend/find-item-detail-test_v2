...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Language options'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Language options'), 0)
