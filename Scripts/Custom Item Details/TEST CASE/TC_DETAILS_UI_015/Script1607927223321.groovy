...
WebUI.verifyElementText(findTestObject('Item Details Objects/Page_diagnostics/div_Description'), 'Description')

WebUI.click(findTestObject('Item Details Objects/Page_diagnostics/div_Description'))
