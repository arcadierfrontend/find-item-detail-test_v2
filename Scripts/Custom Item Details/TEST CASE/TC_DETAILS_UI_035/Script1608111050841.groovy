...
WebUI.waitForElementVisible(findTestObject('Item Details Objects/Page_diagnostics/Page_diagnostics/span_Name_of_manufacturer'), 
    0)

WebUI.verifyElementPresent(findTestObject('Item Details Objects/Page_diagnostics/Page_diagnostics/span_Name_of_manufacturer'), 
    0)
