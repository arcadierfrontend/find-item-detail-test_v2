...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Transportation'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Transportation'), 0)
