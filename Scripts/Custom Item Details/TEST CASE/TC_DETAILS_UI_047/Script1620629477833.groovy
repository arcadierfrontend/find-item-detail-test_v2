...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_User care'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_User care'), 0)
