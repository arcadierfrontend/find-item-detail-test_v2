...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Test strip ejector'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Test strip ejector'), 0)
