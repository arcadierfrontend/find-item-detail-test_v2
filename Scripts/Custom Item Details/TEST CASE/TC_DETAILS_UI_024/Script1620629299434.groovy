...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Cold chain requirements'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Cold chain requirements'), 0)
