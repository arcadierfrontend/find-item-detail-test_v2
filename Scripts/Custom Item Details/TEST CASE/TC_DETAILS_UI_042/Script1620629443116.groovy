...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Technology principle'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Technology principle'), 0)
