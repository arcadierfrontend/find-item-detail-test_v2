...
WebUI.waitForElementVisible(findTestObject('Staging Objects/Page_diagnostics/span_Volume pricing'), 0)

WebUI.verifyElementPresent(findTestObject('Staging Objects/Page_diagnostics/span_Volume pricing'), 0)
